...
import { useMusicReviews, useToggleReviewLike } from '@/features/reviews/hooks';
import { useAuth } from '@/providers/AuthProvider';
import { spacing } from '@/theme/tokens';

/** Community reviews block on album/song pages. */
export function MusicReviewsSection({
  mbid,
  mediaType,
}: {
  mbid: string;
  ...
  const reviews = useMusicReviews(mbid, mediaType);
